...
export namespace Prisma {
  ...
  */
  ...
  export type MarkerOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "place" | "date" | "lat" | "lng", ExtArgs["result"]["marker"]>
  ...
  interface MarkerFieldRefs {
    ...
    readonly lat: FieldRef<"Marker", 'Int'>
    readonly lng: FieldRef<"Marker", 'Int'>
  }
  ...
  export type MarkerWhereInput = {
    ...
    lat?: IntFilter<"Marker"> | number
    lng?: IntFilter<"Marker"> | number
  }
  ...
  export type MarkerScalarWhereWithAggregatesInput = {
    ...
    lat?: IntWithAggregatesFilter<"Marker"> | number
    lng?: IntWithAggregatesFilter<"Marker"> | number
  }
